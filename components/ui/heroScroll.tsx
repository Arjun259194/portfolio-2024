...
import { HeroData, HeroImage } from "@/types/UI";
import { FlipWords } from "./flipWord";

export const HeroParallax = ({ products }: { products: HeroData }) => {
...
export const ProductCard = ({
  ...
  return (
    <motion.div
      ...
      key={product.title}
      className="group/product border-2 overflow-hidden border-violet-500 rounded-xl h-96 w-[30rem] relative flex-shrink-0"
    >
